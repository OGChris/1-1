    ...
    ogApp = new Vue({
      ...
      mounted() {
        ...
        /* if (localStorage.SelectedBackground) {
          if (localStorage.OverideBackground) $('html').css('background-image', `ur
          l("${localStorage.SelectedBackground || this.$root.backgrounds.bg1}")`);
